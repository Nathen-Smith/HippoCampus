    ...
    cards.forEach(function(item) {
      ...
      <li key={item.index}>
                {/* <Card style={{ width: '18rem' }}>
                  <Card.Img variant="top" src="https://www.seekpng.com/png/detail/75-752021_book-stack-png-stack-of-books-clipart.png"/>
                  <Card.Body>
                    <Card.Title>{item.text[0]+ " " + item.text[1]}</Card.Title>
                    <Card.Text>
                      {"Class Standing:" + item.text[2]}
                      <br></br>
                      {"Major:" + item.text[3]}
                      <br></br>
                      {"Bio:" + item.text[4]}
                      <br></br>
                      {"Statement:" + item.text[5]}
                    </Card.Text>
                ...
                <div class="card text-center">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">{item.text[0]+ " " + item.text[1]}</h5>
                    <p class="card-text">
                      {"Class Standing: " + item.text[2]}
                      <br></br>
                      {"Bio: " + item.text[4]}
                    </p>
                    <a href="#" class="btn btn-danger" onClick={this.likedUser.bind(null, item.index)}>❤</a>
                  </div>
